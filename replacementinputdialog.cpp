...
ReplacementInputDialog::ReplacementInputDialog(QString &reqMsg, QString &errMsg,
                                               QWidget *parent)
    : QDialog(parent), ui(new Ui::ReplacementInputDialog)
{
	ui->setupUi(this);
...
QString ReplacementInputDialog::getString(QString &reqMsg, QString &errMsg,
                                          QWidget *parent)
{

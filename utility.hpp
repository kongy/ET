...
static const QString EXPECT_VARIABLE_ERROR_MESSAGE =
    "Error: Expecting input of type Variable";
static const QString VARIABLE_MUST_NOT_OCCUR_ERROR_MESSAGE =
    "Error: Variable must not occur in the statement to be replaced";
static const QString RENAME_PREFIX_MESSAGE =
    "Please enter a variable to rename ";
static const QString VARIABLE_REQUEST_PREFIX_MESSAGE =
    "Please enter a variable for ";
static const QString FORMULA_REQUEST_PREFIX_MESSAGE =
    "Please enter a formula for ";
static const QString BOUND_VARIABLE_REQUEST_PREFIX_MESSAGE =
    "Please enter a bounded variable for ";
static const QString VARIABLE_OCCURS_FREE_ERROR_MESSAGE =
...
static const QVector<QString> messages = {
	EXPECT_VARIABLE_ERROR_MESSAGE,      VARIABLE_MUST_NOT_OCCUR_ERROR_MESSAGE,
	RENAME_PREFIX_MESSAGE,              VARIABLE_REQUEST_PREFIX_MESSAGE,
	FORMULA_REQUEST_PREFIX_MESSAGE,     BOUND_VARIABLE_REQUEST_PREFIX_MESSAGE,
